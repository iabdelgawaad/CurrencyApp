...
class ExchangeRatesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val inflate = inflater.inflate(R.layout.fragment_exchange_rates, container, false)
        return inflate
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button?.setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_exchangeRatesFragment_to_currencyConverterFragment2);
        }
    }
}